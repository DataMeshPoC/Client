...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/talyali/kafka-python-getting-started/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/talyali/kafka-python-getting-started/env/bin/deactivate.nu'
